...
run_model_fit(predictors = c("religious",
                             ...
                             "freedom",
                             "personal_income",
                             "personal_income:gender",
                             "personal_income:religious",
                             "personal_income:education",
                             "personal_income:altruistic_behaviour",
                             "relative_income",
                             "relative_income:gender",
                             "relative_income:religious",
                             "relative_income:education",
                             "relative_income:altruistic_behaviour",
                             ...
                             "gdp:religious",
                             "gdp:education",
                             "gdp:altruistic_behaviour",
                             "growth",
                             "growth:gender",
                             "growth:religious",
                             "growth:education",
                             "growth:altruistic_behaviour",
